 ...
 *  @version $Id: default.php 189 2011-03-03 10:54:35Z nikosdion $
 */
	...
	<div id="cpanel">
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=jupdate">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/update_<?php echo $this->jupdatestatus ?>-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=eom">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/eom-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=masterpw">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/wafconfig-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=acl">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/acl-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=adminpw">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/adminpw-<?php echo $icon ?>-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=htmaker">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/htmaker-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=waf">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/waf-32.png"
		...
		<div class="icon">
			<a href="index.php?option=<?php echo $option ?>&view=dbprefix">
				<img
				src="<?php echo JURI::base(); ?>../media/com_admintools/images/dbprefix-32.png"
		...
		<div class="icon">
			<a href="index.php?option=<?php echo $option ?>&view=adminuser">
				<img
				src="<?php echo JURI::base(); ?>../media/com_admintools/images/adminuser-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=fixpermsconfig">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/fixpermsconfig-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=fixperms&tmpl=component" class="modal" rel="{handler: 'iframe', size: {x: 600, y: 250}}">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/fixperms-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=seoandlink">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/seoandlink-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=cleantmp&tmpl=component" class="modal" rel="{handler: 'iframe', size: {x: 600, y: 250}}">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/cleantmp-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=dbchcol">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/dbchcol-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=dbtools&task=optimize&tmpl=component" class="modal" rel="{handler: 'iframe', size: {x: 600, y: 250}}">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/dbtools-optimize-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=dbtools&task=purgesessions" id="optimize">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/dbtools-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=<?php echo $option ?>&view=redirs">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/redirs-32.png"
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				<a href="index.php?option=com_plugins&view=plugin&client=site&task=edit&cid[]=<?php echo $this->pluginid?>#plugin-pane" target="_blank">
					<img
					src="<?php echo JURI::base(); ?>../media/com_admintools/images/scheduling-32.png"
	...
	<?php JHTML::_('behavior.mootools'); ?>
		...
		<div class="atoolsblock">
			...
			<div>
				...
				<p>If you use Admin Tools, please post a rating and a review at the <a href="http://extensions.joomla.org/extensions/access-a-security/site-security/site-protection/14087">Joomla! Extensions Directory</a>.</p>
			</div>
