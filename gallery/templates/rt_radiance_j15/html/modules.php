...
function modChrome_submenu($module, &$params, &$attribs)
{
	...
	if (isset($item) && $start <= $level) {
		...
		if (!empty ($module->content) && $module->content != '') : ?>
	        ...
	        <?php endif; ?>
	            <div class="rt-block">
					<div class="module-title"><div class="module-title2"><div class="module-title3"><h2 class="title"><?php echo $menu_title_item->name.' '.JText::_('Menu'); ?></h2><div class="accent"></div></div></div></div>
