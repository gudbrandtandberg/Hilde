...
class plgSystemAdmintoolsCore extends JPlugin
{
	...
	public function __construct(& $subject, $config = array())
	{
		...
		{
			$this->cparams = new JParameter($component->params);
		}
		else
		{
			$this->cparams = new JParameter('');
		}
	}
	...
	public function onAfterRender()
	{
		...
		if($this->cparams->get('linkmigration',0) == 1) {
			$this->linkMigration();
		}
		
		if($this->cparams->get('httpsizer',0) == 1) {
			$this->httpsizer();
		}
	}
